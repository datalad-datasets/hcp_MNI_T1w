# Get data from a subset (structural T1 images in MNI space) from the Human Connectome Project Open Access dataset with DataLad
...
The purpose of this dataset as to be a *single* dataset. Compared to the
